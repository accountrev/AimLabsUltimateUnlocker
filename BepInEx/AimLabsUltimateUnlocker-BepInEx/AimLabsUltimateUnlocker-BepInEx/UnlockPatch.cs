...
namespace AimLabsUltimateUnlocker_BepInEx
{
    ...
    internal static class AimLabsPlusSubscriptionPatch
    {
        private static bool Prefix(ref bool __result)
        {
            ...
            Plugin.Log.LogInfo($"Intercepted request for AimLabs+ subscription check ({old_result} -> {__result})");
    ...
    internal static class CosmeticsIsOwnedItemPatchV1
    {
        private static bool Prefix(ref SkinOwnedResult __result)
        {
            ...
            Plugin.Log.LogInfo($"Intercepted request for CosmeticSettingsUtility IsOwnedItem check");
    ...
    internal static class CosmeticsIsOwnedItemPatchV2
    {
        private static bool Prefix(ref SkinOwnedResult __result)
        {
            ...
            Plugin.Log.LogInfo($"Intercepted request for CosmeticSettingsUtility IsOwnedItem CatalogItem variant check");
    ...
    internal static class CosmeticsOwnsWeaponSkinPatch
    {
        private static bool Prefix(ref SkinOwnedResult __result)
        {
            ...
            Plugin.Log.LogInfo($"Intercepted request for CosmeticSettingsUtility OwnsWeaponSkin check");
    ...
    internal static class CosmeticsHasSkinPatch
    {
        private static bool Prefix(ref SkinOwnedResult __result)
        {
            ...
            Plugin.Log.LogInfo($"Intercepted request for CosmeticSettingsUtility HasSkin check");
    ...
    internal static class CosmeticsIsOwnedSkinPatch
    {
        private static bool Prefix(ref SkinOwnedResult __result)
        {
            ...
            Plugin.Log.LogInfo($"Intercepted request for CosmeticSettingsUtility IsOwnedSkin check");
    ...
    internal static class CosmeticsOwnsArmSkinPatch
    {
        private static bool Prefix(ref SkinOwnedResult __result)
        {
            ...
            Plugin.Log.LogInfo($"Intercepted request for CosmeticSettingsUtility OwnsArmSkin check");
    ...
    {
        private static void Postfix(ProfileCustomizationImageSelectionBinding __instance, Il2CppSystem.Threading.Tasks.Task __result)
        {
